...
const Features = () => {
  return (
    <div className='text-white bg-gradient-to-b items-center  from-black  to-[#381a5f]  py-18 mt-40  ' id='portfolio'>
                    <motion.div  initial={{opacity:0,y:75}}
                              ...
                              <p> How it </p>  <p className='text-purple-400'> works? </p>  
                    </motion.div>
                            ...
                            <motion.div
                             ...
                             >
                                    ...
                                    <div className='justify-center  flex items-center'>
                                        <Image src={project.src} alt={project.title} className='h-[350px] border  rounded w-[500px] object-cover ' />
                                    </div>
                            </motion.div>
                        ))}
                    </div>
